...
import { TOKEN_ABI } from "../contract/TOKEN";
import { EXCHANGE_ABI } from "../contract/EXCHANGE";
...
//--------------------------------------------------------------------------
//Load User Balances (wallet & exchange Balance)

export const loadBalances=async(exchange,tokens,account,dispatch)=>{
    let balance=ethers.utils.formatUnits(await tokens[0].balanceOf(account))
