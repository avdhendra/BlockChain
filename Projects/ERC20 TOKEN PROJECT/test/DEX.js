...
describe("DEX",()=>{
    ...
    //before each run before each test case
    //before do run before each describe
    before(async()=>{
...
it("Should return correct token price",async()=>{
    ...
    describe("Buy",()=>{
        ...
        it("User cannot buy with invalid value",async()=>{
            await expect(dex.connect(addr1).buy(91,{value:510})).to.be.reverted;
        })
    })
...
it("Owner can withdraw tokens",async()=>{
    ...
    describe("Withdraw funds",()=>{
        it("Owner can withdraw token proceed",async()=>{
